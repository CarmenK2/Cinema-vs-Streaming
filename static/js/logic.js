...
d3.json("/ah_data").then(function(twentyTwo) {
    ...
    for (var i = 0; i < twentyTwo.length; i++) {
        ...
        var cinemaLat1 = Object.assign({},twentyTwo[i].latitude, twentyTwo[i].latitude);
        ...
        var cinemaLong1 = Object.assign({}, twentyTwo[i].longitude, twentyTwo[i].longitude);
        // console.log(cinemaLong);
        // Create a new marker with the appropriate icon and coordinates
        var newMarker = L.marker([parseFloat(cinemaLat1), parseFloat(cinemaLong1)], {
            icon: icons[cinemaStatusCode]
        });
        
        console.log(newMarker)
        // var newMarker = L.marker(L.latLng( parseFloat(cinemaLat1),
        // parseFloat(cinemaLong1)), {
        // icon: icons[cinemaStatusCode]
        // });
